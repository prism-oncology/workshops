...
1. [`1_preprocessing.ipynb`](https://github.com/prism-oncology/workshops/blob/main/spatial/cirm_2026/1_preprocessing.ipynb) introduces Sopa and SpatialData on a light synthetic dataset. It's a quick tutorial that is fully guided: no code has to be filled.
2. [`2_postprocessing.ipynb`](https://github.com/prism-oncology/workshops/blob/main/spatial/cirm_2026/2_postprocessing.ipynb) acts as you already pre-processed your data and now work only on the `AnnData` object. It uses scConcept and Novae for postprocessing of real data (embeddings were pre-computed for conveniency). Adding code is required to walk through this notebook.
